# Generated by Powerlevel10k configuration wizard on 2025-09-11 at 11:41 NZST.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh.
# Wizard options: nerdfont-v3 + powerline, small icons, rainbow, ascii, 2 lines, dotted,
# darkest-ornaments, sparse, concise, transient_prompt, instant_prompt=auto-quiet.
